...
export const SecondSection = ({ position }) => {
  ...
  const { 
    fontFirstLine, scaleFirstLine, colorFirstLine, 
    fontSecondLine, scaleSecondLine, colorSecondLine, 
    fontBody, scaleBody, colorBody, 
    showSnowman, colorSnowman, positionSnowman
  } = useControls('Second Section', {
    firstLine: folder({
